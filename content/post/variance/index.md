...
about variance - and it's cousin the standard deviation - 
that I don't remember ever being taught in one place.
...
The corresponding population standard deviaiton is
...
Note that $\textbf{x} + y = [x_1 + y_1, x_2 + y_2, ..., x_n + y_n]$, etc.
...
*If we multiply $x$ by $k$, we multiply it's standard deviation by $k$, and it's variance by $k^2$*.
